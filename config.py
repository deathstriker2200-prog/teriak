...
PV_ATTACK_SUGGESTIONS = 5         # تعداد هدف پیشنهادی تو لیست
...
HEAL_ITEMS = {
    "band": {"name": "🩹 باند کوچک",          "heal": 100,  "price": 400,  "desc": "بخشی از HP رو برمی‌گردونه"},
    "kit":  {"name": "💉 کیت درمان",           "heal": 250,  "price": 900,  "desc": "مقدار بیشتری HP برمی‌گردونه"},
