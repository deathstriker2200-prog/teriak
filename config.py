...
# نمونه روی HP 600: حمله 700 دفاع 443 (دو طرف مکس) ≈ 36 دمیج | حمله 700 دفاع 250 ≈ 42 | حمله 880 دفاع 235 ≈ 44
# (درخواست کارفرما: دمیج تقویت شد، قبلاً دوئل مکس 12 تا 18 می‌زد)
# دمیج هر ضربه درصدی از مکس HP قربانیه (که هیچ‌وقت نبرد یک‌ضربه‌ای نشه):
# نسبت قدرت حمله به (حمله+دفاع) مشخص می‌کنه توی بازه کف تا سقف کجا بشینه
BATTLE_DMG_PCT_MIN = 0.05      # حداقل دمیج، ۵% مکس HP حریف (قدرت خیلی کمتر از حریف) | تقویت بزرگ درخواست کارفرما (راند ۸)
BATTLE_DMG_PCT_MAX = 0.20      # حداکثر دمیج، ۲۰% مکس HP حریف (قدرت خیلی بیشتر از حریف) | تقویت بزرگ درخواست کارفرما (راند ۸)
...
SEARCH_OUTCOMES = [
    {"key": "money",       "chance": 0.326, "emoji": "💰", "text": "مقداری پول پیدا کردی",        "min": 100, "max": 700},
    ...
    {"key": "seed_hell",   "chance": 0.015, "emoji": "🔥", "text": "بذر جهنم پیدا کردی",          "pool": ["jahannam"]},
    {"key": "seed_devil",  "chance": 0.01, "emoji": "😈", "text": "بذر ابلیس پیدا کردی",         "pool": ["eblis"]},
    {"key": "seed_mutant", "chance": 0.004, "emoji": "☣️", "text": "بذر جهش‌یافته پیدا کردی",     "pool": ["mutant"]},
