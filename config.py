...
MAINTENANCE_TEXT = "<b>🔧 ربات تریاکی در دست توسعه و تعمیره\nلطفاً صبور باشید</b>"
...
BANK_CAPS = [20000, 50000, 100000, 200000, 500000]
# هزینه ارتقای بانک از لول n به n+1 (اندیس 0 = از لول ۱ به ۲)
BANK_UPGRADE_PRICES = [25000, 50000, 100000, 200000]
# حداقل لول بازیکن برای هر لول بانک (اندیس ۰ = لول ۱)
BANK_MIN_LEVELS = [1, 4, 8, 12, 16]
...
WEATHER_ROLL_SECONDS = 6 * 3600      # هر ۶ ساعت عوض میشه
...
# kind = نوع افکت: speed سرعت رشد | time زمان رشد | sell فروش | atk حمله | def دفاع | q5 شانس ۵ ستاره
...
WEATHERS = {
    ...
    "moon": {
        "emoji": "🌕", "name": "شب مهتابی", "kind": "q5", "sign": 1, "base": 10,
        "announce": ["شانس محصول ⭐⭐⭐⭐⭐ به مقدار {p}% افزایش پیدا کرد"],
        "effects": ["شانس ⭐⭐⭐⭐⭐ مثبت {p}%"],
    },
    "frost": {
...
MARKET_MAX_PRICE_MULTIPLIER = 1.25     # سقف قیمت، نهایت ۲۵ درصد بالاتر از قیمت پایه
MARKET_MIN_PRICE_MULTIPLIER = 0.75     # کف قیمت، نهایت ۲۵ درصد پایین‌تر از قیمت پایه
MARKET_MAX_STEP_CHANGE = 0.03          # حداکثر حرکت تو هر بروزرسانی، ۳ درصد قیمت پایه
MARKET_RANDOM_NOISE = 0.01             # نویز کوچیک پایانی روی هر رول تا بازار حس زنده بودن بگیره
...
TEAM_RENAME_COST = 50000         # هزینه «تیم تغییر نام» که رهبر از جیب خودش میده
