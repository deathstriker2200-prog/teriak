...
# ───────── لول‌آپ زمین ─────────
# هر لول آپ: ۲۵% درآمد بیشتر + ۴۰% سرعت رشد بیشتر، تا لول ۵ قابل آپگریده
PLOT_MAX_LEVEL = 5
PLOT_YIELD_PER_LEVEL = 1.25     # ×۱٫۲۵ درآمد به ازای هر لول
PLOT_SPEED_PER_LEVEL = 1.40     # زمان رشد ÷۱٫۴۰ به ازای هر لول
# هزینه لول‌آپ زمین از لول n به n+1 (اندیس 0 = از لول ۱ به ۲)، سنگین و رند (حدود ۲٫۵ برابر قبل)
PLOT_UPGRADE_PRICES = [4000, 10000, 22000, 45000]
...
STEAL_MIN_PCT = 0.05            # حداقل درصد سرقت (برد → 5 تا 10% جیب قربانی)
STEAL_MAX_PCT = 0.10            # حداکثر درصد سرقت
ATTACK_WIN_XP_MIN = 12        # تجربه برد تو حمله رندوم بین ۱۲ تا ۳۵
ATTACK_WIN_XP_MAX = 35
ATTACK_LOSE_XP_MIN = 3        # تجربه باخت خیلی کمتره، بین ۳ تا ۷
ATTACK_LOSE_XP_MAX = 7
ATK_BASE = 4
ATK_PER_LEVEL = 2
DEF_BASE = 3
DEF_PER_LEVEL = 2
# سیستم نبرد قدرتمحور: شانس برد از اختلاف قدرت دو طرف حساب میشه نه شانس خالص
ATTACK_CHANCE_SCALE = 1.5       # حساسیت شانس به اختلاف قدرت (اختلاف نسبی × این)
ATTACK_WIN_MIN_CHANCE = 0.08    # کف شانس، هیچ‌وقت باخت ۱۰۰% تضمینی نیس
ATTACK_WIN_MAX_CHANCE = 0.92    # سقف شانس، هیچ‌وقت برد ۱۰۰% تضمینی نیس
# دمیج نمایشی بر اساس قدرت سلاح + ضربه بحرانی
ATTACK_CRIT_CHANCE = 0.05       # حدود ۵% ضربه بحرانی
ATTACK_CRIT_DMG_MULT = 1.5      # دمیج بحرانی ×۱٫۵
ATTACK_CRIT_STEAL_MULT = 1.30   # غارت با ضربه بحرانی +۳۰%
# سپر محافظ: هدف هر حمله برای این مدت امنه، خودش حمله کنه سپرش می‌شکنه
ATTACK_SHIELD_MINUTES = 15
