...
MARKET_MAX_STEP_CHANGE = 0.03          # پایه حرکت تو هر بروزرسانی، شانسی بین 3 تا 4.8 درصد قیمت پایه
MARKET_SELL_SATURATION_MAX = 3.0       # اشباع فروش تا این ضریب افت رو عمیق‌تر می‌کنه (فروش سنگین = ریزش تند)
MARKET_BAND_JITTER = 0.05              # سقف و کف واقعی هر رول دور و بر 25% شانسی جابه‌جا میشن (±5%)
MARKET_RANDOM_NOISE = 0.015            # نویز کوچیک پایانی روی هر رول تا بازار حس زنده بودن بگیره
