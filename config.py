...
WEATHERS = {
    "normal": {"emoji": "🌤", "name": "هوای عادی", "boosts": []},
    "rain":   {"emoji": "🌧", "name": "باران",        "speed": 1.30, "boosts": ["سرعت رشد +30٪"]},
    "heat":   {"emoji": "☀️", "name": "گرمای شدید",  "speed": 0.80, "boosts": ["سرعت رشد 20٪−"]},
    "fog":    {"emoji": "🌫", "name": "مه",           "def_mod": 0.20, "boosts": ["دفاع +20٪"]},
    "storm":  {"emoji": "🌪", "name": "طوفان",        "atk_mod": -0.10, "boosts": ["موفقیت حمله 10٪−"]},
    "fest":   {"emoji": "🌈", "name": "جشن برداشت",  "sell_mod": 0.50, "boosts": ["قیمت فروش +50٪"]},
    "moon":   {"emoji": "🌕", "name": "شب مهتابی",   "q5": 0.10, "boosts": ["شانس محصول ⭐⭐⭐⭐⭐ +10٪"]},
    "frost":  {"emoji": "❄️", "name": "سرمای شدید",  "speed": 1 / 1.15, "boosts": ["زمان رشد +15٪"]},
}
