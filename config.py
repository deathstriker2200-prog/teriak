...
# هزینه لول‌آپ زمین از لول n به n+1 (اندیس 0 = از لول ۱ به ۲) — اعداد رند برای لول‌های بالا
PLOT_UPGRADE_PRICES = [1500, 4000, 9000, 18000, 32000, 55000, 85000, 130000, 190000]
...
MARKET_MIN_PCT = -40               # کف درصد تغییر
MARKET_MAX_PCT = 120               # سقف درصد تغییر
