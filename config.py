...
PLOT_CATALOG = {
    ...
    5: {"price": 400000, "build_sec": 43200,      "min_level": 20},  # 12 ساعت
}
# ───────── لول‌آپ زمین ─────────
...
# راند ۱۰ درخواست کارفرما: تجربه تریاک و کوکائین بیشتر و بذرهای پایانی‌تر کمتر، بازه تجربه بذرهای عادی فشرده شد به ۲ تا ۲۲ (افسانه‌ای‌ها دست نخوردن)
SEEDS = {
    "marijuana": {"name": "ماری‌جوانا",  "emoji": "🌿", "price": 120,  "grow_min": 5,  "sell": 300,   "xp": (2, 3), "min_level": 1,  "desc": "محصول شروع هر دلال"},
    "gharch":    {"name": "قارچ",         "emoji": "🍄", "price": 320,  "grow_min": 8,  "sell": 800,   "xp": (3, 4), "min_level": 3,  "desc": "کپک سحرآمیز و پرطرفدار"},
    "peyote":    {"name": "پیوت",         "emoji": "🌵", "price": 850,  "grow_min": 12, "sell": 2100,  "xp": (4, 5), "min_level": 4,  "desc": "کاکتوس جادویی صحرا"},
    "kratom":    {"name": "کراتوم",       "emoji": "🍃", "price": 1300, "grow_min": 14, "sell": 3400,  "xp": (5, 7), "min_level": 5,  "desc": "برگ سبز انرژی‌بخش شرق"},
    "khashkhash": {"name": "خشخاش سیاه",   "emoji": "🌺", "price": 1450, "grow_min": 16, "sell": 3600,  "xp": (6, 9), "min_level": 7,  "desc": "گل سیاهی که تریاک ازش در میاد"},
    "teriak":    {"name": "تریاک",        "emoji": "☕", "price": 1600, "grow_min": 18, "sell": 4000,  "xp": (11, 16), "min_level": 10, "desc": "طلای سیاه محله"},
    "cocaine":   {"name": "کوکائین",      "emoji": "⚪", "price": 4000, "grow_min": 25, "sell": 10000, "xp": (15, 22), "min_level": 14, "desc": "پودر سفید قیمتی"},
...
# لول‌های پایین مثل قبله، لول‌های بالا طوریه که خروجی کامل ۱۲ ساعت کارخونه مکس (چوب‌بری ۲۸۸۰ | آهن ۳۶۰۰) توش جا بشه
...
RES_SHOP = {
    "wood": {"name": "چوب", "emoji": "🪵", "unit": 150},
    "iron": {"name": "آهن", "emoji": "⛏️", "unit": 300},
}
...
# ظرفیت انبار هر لول = per_tick × ۷۲ تیک ← چوب‌بری 288 | کارخانه آهن 360، با هر ارتقا بیشتر میشه
...
# تولید هر تیک هم یه کم پایین اومده
...
FACTORIES = {
    "lumber": {
        ...
        "per_tick": 4,              # هر لول هر تیک ۴ چوب (۲۴ چوب در ساعت روی هر لول)
    ...
    "ironmill": {
        ...
        "per_tick": 5,              # هر لول هر تیک ۵ آهن (۳۰ آهن در ساعت روی هر لول)
...
# فرمول درخواستی کارفرما (راند ۹): دمیج = (حمله - دفاع حریف) ÷ BATTLE_DMG_DIVISOR
# نمونه: حمله 700 دفاع 443 (دو طرف مکس) ≈ 86 دمیج | حمله 700 دفاع 250 ≈ 150 | حمله 880 دفاع 235 ≈ 215
# دفاعی به‌بزرگی حمله یا بیشتر ≈ هیچ دمیجی (هنوز انرژی و کولدان می‌سوزونه)، اختلاف خیلی زیاد = «زورت نمی‌رسه»
BATTLE_DMG_DIVISOR = 3          # تقسیمگر دمیج (درخواست کارفرما راند ۹): دمیج = (حمله - دفاع حریف) ÷ 3، بعد واریانس
BATTLE_DMG_VARIANCE = 0.30    # دمیج نهایی تا ۳۰% بیشتر یا کمتر رندوم میشه
BATTLE_NO_DAMAGE_DEF_RATIO = 3.0  # فقط وقتی دفاع ≥ این مقدار برابر حمله بود «زورت نمی‌رسه» میاد
...
PV_SPY_MIN_COST = 50            # هزینه «جاسوسی» تو لول ۱، جیب و دفاع و شانس طرف رو لو میده
PV_SPY_MAX_COST = 1000          # هزینه «جاسوسی» تو مکس لول، بین اینا خطی با لول جست‌وجوگر
...
HEAL_ITEMS = {
    "band": {"name": "🩹 باند کوچک",          "heal": 75,   "price": 750,   "desc": "بخشی از HP رو برمی‌گردونه"},
    "kit":  {"name": "💉 کیت درمان",           "heal": 150,  "price": 2000,  "desc": "مقدار بیشتری HP برمی‌گردونه"},
...
WEAPONS = {
    ...
    "oblivion": {"name": "👑 Oblivion",   "price": 280000, "iron": 120, "attack": 250, "min_level": 20, "desc": "هر ضربه یه جور مرگ با خودش داره", "gun": True, "sec": "special",
...
WEAPON_ABILITY_TEXT = {
    "poison": "💀 10% احتمال سم، حریف مقداری ضعیف‌تر میشه",
    "hellfire": "🔥 سلامت حریف زیر 30% باشه، 10% دمیج بیشتر",
    "vampire": "🩸 10% از دمیج به سلامت خودت برمی‌گرده",
    "shadow": "🌑 هنگام شب (18 تا 4) 20% دمیج بیشتر",
    "oblivion": "👑 هر حمله یکی از قابلیت‌های دیگر سلاح‌های ویژه، به‌صورت تصادفی فعال میشه",
}
...
# ───────── لقب‌ها 🏅 (بر اساس لول، تو پروفایل و لیدربرد و لیست اعضای تیم) ─────────
...
TEAM_CREATE_COST = 50000        # هزینه ساخت تیم
TEAM_NAME_MAX = 24
TEAM_BIO_MAX = 120
...
TEAM_XP_CURVE_BASE = 1000       # xp لازم تیم برای لول N = این × N^TEAM_XP_CURVE_EXP (سخت‌تر، نزدیک‌تر به روند بازیکن)
TEAM_XP_CURVE_EXP = 1.8
TEAM_XP_CURVE_MIGRATION_FROM = (200, 1.6)  # منحنی قبلی، فقط برای تبدیل سطح تیم‌های موجود تو /update به کار میره
# ظرفیت اعضای تیم به ازای هر لول، جدول دستی: لول ۱ = ۱۰ نفر تا لول ۱۰ = ۳۰ نفر
...
TRF_MAX_AMOUNT = 100000       # حداکثر مبلغ هر انتقال بانکی
TRF_COOLDOWN_SECONDS = 60     # کولدان بین دو انتقال موفق، «تازه انتقال دادی تا X ثانیه دیگه...»             # طول شماره حساب بانکی (مثل F8L6XS)
...
# تعداد برداشت شانسی بر اساس لول زمین (درخواست کارفرما): افسانه‌ای‌ها همیشه 1 تا میدن، بقیه رول از جدول زیر
# هر ردیف لول زمین: (تعداد, درصد) و جمع هر ردیف 100ـه | لول 2 سه‌تایی رو باز می‌کنه، لول 3 چهارتایی، لول 4 پنج‌تایی، لول 5 شش‌تایی، لول 6 (آخر) فقط درصدها رو بهتر می‌کنه
# شانس 5تایی و 6تایی عمداً کم شروع میشه و مرور آپگرید میره بالا (درخواست کارفرما): 5تایی 5→7→15 و 6تایی 6→8
HARVEST_QTY_CHANCES = {
    1: ((1, 70), (2, 30)),
    2: ((1, 60), (2, 30), (3, 10)),
    3: ((1, 50), (2, 30), (3, 14), (4, 6)),
    4: ((1, 40), (2, 28), (3, 18), (4, 9), (5, 5)),
    5: ((1, 28), (2, 26), (3, 20), (4, 13), (5, 7), (6, 6)),
    6: ((1, 7), (2, 20), (3, 25), (4, 25), (5, 15), (6, 8)),
}
...
SHIPMENT_BASE_SECONDS = 600        # پایه زمان ارسال محموله
SHIPMENT_PER_UNIT_SECONDS = 6      # هر واحد محصول این ثانیه به زمان ارسال اضافه می‌کنه (20 تا | 12 دقیقه)
SHIPMENT_MAX_ACTIVE = 5            # سقف محموله‌های هم‌زمان در راه هر بازیکن
SHIPMENT_QTY_CHOICES = [10, 25, 50]  # دکمه‌های مقدار فروش (به‌علاوه «همه»)
SHIPMENT_POLICE_CHANCE = 0.08      # احتمال توقیف محموله توسط پلیس
SHIPMENT_POLICE_PAY = 0.70         # بعد توقیف فقط این کسر از ارزش محموله پرداخت میشه
