...
# ───────── زمین (Plot) ─────────
PLOT_BASE_PRICE = 1000
PLOT_PRICE_GROWTH = 1.65
MAX_PLOTS = 8
PLOT_MAX_LEVEL = 3
...
# خرید زمین شماره n نیازمند لول n (گیت لول — لول روی خرید زمین اثر می‌ذاره)
...
# ───────── سلاح‌ها (فروشگاه 🔪) ─────────
WEAPONS = {
    "knife":   {"name": "چاقو",            "price": 400,   "attack": 6,   "min_level": 1,  "desc": "سلاح کلاسیک محله"},
    "pipe":    {"name": "میله آهنی",        "price": 1200,  "attack": 14,  "min_level": 3,  "desc": "سنگین و زخمی"},
    "shocker": {"name": "شوکر دست‌ساز",      "price": 3500,  "attack": 30,  "min_level": 5,  "desc": "برق می‌گیرهت"},
    "deagle":  {"name": "کلت نقره‌ای",       "price": 10000, "attack": 60,  "min_level": 8,  "desc": "خشن و پرسرعت"},
    "plasma":  {"name": "شلیک‌کن پلاسما",    "price": 30000, "attack": 130, "min_level": 12, "desc": "آینده‌گرایانه و کشنده"},
}
...
DOGS = {
    ...
    "blackwolf": {
        ...
        "ability": "بسته به لولش تا ۱۵٪ سکه دزدیده‌شده از حریف رو زیاد می‌کنه 👑",
