...
💡 **از این ورژن ربات خودش ولوم رو تشخیص میده** — اگه `/data` سوار باشه اتوماتیک دیتابیس رو اونجا می‌سازه و لازم نیس `TERIAKY_DB` رو دستی ست کنی. تو لاگ‌استارت نوشته کدوم مسیر استفاده شده
...
| `TERIAKY_ADMIN_IDS` | آیدی عددی تلگرامت — برای پنل ادمین (با کاما چندتا) | ✅ پیشنهادی |
