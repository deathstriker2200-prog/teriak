...
HELP_SECTIONS: dict[str, str] = {
    ...
    "attack": (
        "<b>⚔️ حمله</b>\n\n"
        "برای حمله در گروه روی پیام بازیکن ریپلای کن و بنویس «تریاکی حمله»\n\n"
        "در پیوی هم از بخش ⚔️ می‌تونی یک حریف در بازه لولی خودت پیدا کنی\n\n"
        "قدرت حمله از قدرت پایه، سلاح، سگ، لول، شخصیت سگ، آب و هوا و ساختمان تیم حساب میشه\n"
        "و دفاع حریف هم از دفاع پایه، زره، لول، آب و هوا و ساختمان دفاع تیمش\n\n"
        "🎯 شانس بردت از اختلاف این دو قدرت به دست میاد، اگه قدرت‌ها نزدیک باشن شانس 50% میشه و هیچ‌وقت 100% نمیشه\n\n"
        "💣 هر حمله 5% شانس ضربه بحرانی داره که هم دمیج رو زیاد می‌کنه هم سکه بیشتری غارت میشه\n\n"
        "💥 دمیجی که تو پیام نبرد نشون داده میشه از قدرت سلاحت محاسبه میشه\n\n"
        "🛡 بعد از هر حمله، هدف 15 دقیقه سپر محافظ می‌گیره و تا تموم شدنش نمی‌شه دوباره بهش زد\n"
        "اگه خودت سپر داشته باشی با زدن حمله سپرت می‌شکنه\n\n"
        "هر 1 دقیقه یک بار می‌تونی حمله کنی و هر حمله مقداری انرژی مصرف می‌کنه\n\n"
        "در صورت پیروزی بین 5% تا 10% سکه حریف رو غارت می‌کنی\n\n"
        "👑 گرگ سیاه تا 30% دفاع حریف رو کاهش میده و سکه بیشتری از حمله به دست میاره\n"
        "👑 زره افسانه‌ای مقدار سکه‌ای که از صاحبش غارت میشه رو نصف می‌کنه\n\n"
        "اگر شکست بخوری 15 انرژی از دست میدی اما همچنان تجربه دریافت می‌کنی\n\n"
        "وضعیت آب و هوایی موثر بر حمله\n\n"
        "🌪 طوفان قدرت حمله همه رو 10% کاهش میده\n\n"
        "🌫 مه دفاع همه بازیکن‌ها رو 20% افزایش میده"
    ),
    "dogs": (
        "<b>🐕 سگ‌ها</b>\n\n"
    ...
    "team": (
        "<b>🏴 تیم</b>\n\n"
        "از لول 10 می‌تونی با دستور «تریاکی ساخت تیم» تیم خودت رو بسازی\n"
        "اول اسم تیم رو می‌دی، بعد فاکتورش میاد و با تایید ✅ تیم ساخته میشه\n\n"
        "از لول 5 می‌تونی با دستور «تریاکی جوین تیم [نام تیم]» به یک تیم ملحق بشی\n\n"
        "هر تیم حداکثر 10 عضو می‌تونه داشته باشه\n\n"
        "با دستور «تریاکی تیم [نام تیم]» اطلاعات هر تیم رو ببین\n"
        "با «تریاکی تیم من» اطلاعات تیم خودت نمایش داده میشه\n\n"
        "«تریاکی تیم پروفایل» مشخصات کامل، ساختمان‌ها و آمار تیم رو نشون میده\n"
        "«تریاکی تیم عضویت» فهرست اعضای تیم رو نمایش میده\n\n"
        "رهبر تیم می‌تونه با دستور «تریاکی ست بیو تیم [متن]» توضیحات تیم رو تغییر بده\n\n"
        "با «تریاکی تیم کوئست» مأموریت روزانه تیم رو انجام بدین تا همه اعضا جایزه بگیرن و بخشی از پاداش به بانک تیم اضافه بشه\n\n"
        "«تریاکی کنده‌کاری تیمی» با حداقل 3 عضو شروع میشه و باید حداقل 70% اعضا شرکت کنن تا پاداش دریافت کنید\n\n"
        "با «تریاکی تیم بانک» موجودی بانک تیم رو ببین\n"
        "با «تریاکی تیم واریز [مبلغ]» به بانک تیم کمک مالی کن\n\n"
        "رهبر تیم از بخش «تریاکی تیم ساختمان» می‌تونه ساختمان‌های حمله و دفاع رو با استفاده از موجودی بانک ارتقا بده و بونس اون به همه اعضا تعلق می‌گیره\n\n"
    ...
    "mine": (
        ...
        "تنها دستوریه که تریاکی اولش نمی‌خواد\n\n"
...
_NOOP_ANSWERS = {
    ...
    "depinfo": "💰 تو گروه یا پیوی بنویس «تریاکی تیم واریز 1200»، عددش خودته",
