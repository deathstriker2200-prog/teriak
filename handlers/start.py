...
HELP_SECTIONS: dict[str, str] = {
    ...
    "shelter": (
        ...
        "یورش پلیس به انبارت ضربه می‌زنه و مخفیگاه خسارتش رو کم می‌کنه و شانس فرار میده\n"
        "جزئیات یورش رو تو بخش 🧭 متفرقه ببین"
    ),
    "team": (
        "<b>👥 تیم</b>\n\n"
    ...
    "resources": (
        ...
        "چوب و آهن اضافه رو از بخش فروش منابع مخفیگاه می‌فروشی\n"
    ...
    "mine": (
        "<b>⛏ کنده‌کاری</b>\n\n"
        "با «تریاکی کنده کاری» یا فقط «کنده کاری» هر 30 ثانیه یه بار می‌تونی کار کنی\n"
        ...
        "🍀 گاهی «شکار کمیاب» میفته و هر چوب و آهنی که همون لحظه گیرت اومده رو\n"
        "چند برابر می‌کنه؛ هرچی ابزارت بالاتر باشه شانس این شکار هم بیشتره"
    ),
    "casino": (
        "<b>🎰 قمارخانه</b>\n\n"
    ...
    "bank": (
        "<b>🏦 بانک</b>\n\n"
        "با «تریاکی بانک» پولت رو از خطر پلیس و حمله‌ی بقیه دور نگه دار\n"
        "پول تو بانک برخلاف پول نقدت با یورش پلیس یا غارت حریف از دست نمیره\n\n"
    ...
    "misc": (
        ...
        "👮 پلیس، هر چند وقت یه بار به بازیکنای فعال سر می‌زنه و بخشی از\n"
        "محصول انبارت رو می‌سوزونه؛ لول مخفیگاه بالاتر هم خسارت رو کم می‌کنه\n"
        "هم شانس فرار میده\n\n"
